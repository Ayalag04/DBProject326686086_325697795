...
הוכחה שהטריגר עובד על ידי הסתכלות בלוג שנוצר:
...
טכנולוגיות וכלים בהם השתמשנו
Node.js + Express – לבניית השרת וה-API. כל הפעולות (שליפה, עדכון, הוספה, מחיקה) נשלחות דרך קריאות REST אל מסד הנתונים.

PostgreSQL – מסד הנתונים של האפליקציה. במסד מוגדרות טבלאות כמו person, reservation, payment, ו-activity, בנוסף לפונקציות ופרוצדורות מורכבות ב-PL/pgSQL.

HTML + JavaScript – לבניית ממשק המשתמש בצד הלקוח.

Bootstrap – לסגנון עיצובי רספונסיבי ונוח ללא צורך בכתיבת CSS מותאם.

pg (ספריית Node) – לביצוע שאילתות למסד הנתונים מתוך Node.js.

Git – לניהול גרסאות הקוד.

במהלך העבודה הקפדנו על שימוש בתבניות קוד מסודרות, בניית ממשק ברור למשתמש, וכתיבת קוד קריא וניתן לתחזוקה.

⚙️ הוראות הפעלה של האפליקציה
דרישות מוקדמות:

Node.js מותקן על המחשב.

PostgreSQL מותקן ופועל עם הרשאות מתאימות.

קובץ functions.sql (שנמצא בתיקיית stage 4) צריך להיות מריץ במסד כדי ליצור את כל הטבלאות והפונקציות הדרושות.
התקנת המערכת:

יש להיכנס לתיקיית stage 5 בפרויקט.

לפתוח שורת פקודה בתיקייה זו.

להריץ את הפקודה:

npm install
פעולה זו תתקין את כל הספריות הדרושות לפרויקט (כמו Express, pg ועוד).
קובץ הגדרות למסד הנתונים:

יש ליצור קובץ db.js בתיקיית stage 5 שיראה כך:
...
בתוך תיקיית stage 5 להריץ:

node server.js
השרת יופעל בברירת מחדל על פורט 3000.

גישה לאפליקציה:

יש לפתוח דפדפן ולהיכנס לכתובת:

http://localhost:3000


 מה ניתן לבצע במערכת
ניהול אנשים (person): הוספה, עדכון, מחיקה והצגה של אנשים.

הזמנות (reservation): צפייה בהזמנות, סטטוס, פעילות ושיוך לאורח ולתשלום.

תשלומים (payment): שמירת תשלומים לכל הזמנה, הפעלת פרוצדורה להצגת סכום כולל.

פעילויות זמינות: הפעלת פונקציה שמחזירה פעילויות עם מקומות פנויים בלבד.

בדיקת סוג אדם: הפעלת פונקציה שבודקת אם אדם הוא אורח, עובד, שניהם או אף אחד מהם ומדפיסה תוצאה דרך RAISE NOTICE במסד.


לסיכום
המערכת משלבת צד שרת, צד לקוח ומסד נתונים למערכת ניהול מקיפה, עם קוד פתוח, אפשרות להרחבה בעתיד, וממשק נוח למשתמש.
פיתוח המערכת דרש תכנון מוקדם, יישום פרוצדורות חכמות במסד, ועבודה מדויקת בין חלקי התוכנה השונים.
...
מסך פתיחה:
![Screenshot 2025-06-23 021746](https://github.com/user-attachments/assets/ae35cf56-cd19-49cc-b83e-7f8a96ac9fc3)
...
![Screenshot 2025-06-23 021811](https://github.com/user-attachments/assets/73f9be2c-d6d4-47f7-8a27-439810136170)




פונקציות crud הזמנות:



![Screenshot 2025-06-23 021838](https://github.com/user-attachments/assets/add7f5ad-5844-452f-8323-78bff8cdf24a)


דוגמה למחיקה:

![Screenshot 2025-06-23 021857](https://github.com/user-attachments/assets/2dff0a71-426b-460b-b78e-ffb60da64f29)


![Screenshot 2025-06-23 021915](https://github.com/user-attachments/assets/b66bd067-37f8-4053-8b1f-1dafe791c193)



הפעלת הפונקציות, פרוצדורות ושאילתות:


![Screenshot 2025-06-23 021952](https://github.com/user-attachments/assets/5e093225-f28b-4d00-98a2-3260994a231e)



![Screenshot 2025-06-23 022011](https://github.com/user-attachments/assets/f1bbcf44-e168-4f44-b6c8-05fbc0745cbc)



![Screenshot 2025-06-23 022033](https://github.com/user-attachments/assets/af1dc0b3-cef3-4e00-a21b-6378371a35ca)
